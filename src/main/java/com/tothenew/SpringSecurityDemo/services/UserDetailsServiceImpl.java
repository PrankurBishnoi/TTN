...
public class UserDetailsServiceImpl implements UserDetailsService
{
    ...
    public void  initialiseDatabase()
    {
        ...
        userRepository.save(new User("Shivam",passwordEncoder.encode("shivam"), Arrays.asList(Roles.ADMIN.getRole(),Roles.USER.getRole()),true,true,true,true));
    ...
    {
       String encryptpassword = passwordEncoder.encode("shivam");
